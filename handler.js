...
module.exports = handle = (client, Client) => {
    try {
        ...
        //         if(mediaBuffer) Client.sendFileFromBase64(dataC.jid, mediaBuffer.toString('base64'), `bc.${ext}`, `*SAGITA BROADCAST*\n\n${data.body} ${dataC.jid.endsWith('@g.us') ?'\n\n_#izin admin grup _*'+dataC.name+'*_' : ''}`)
        //         else Client.sendText(dataC.jid, `*SAGITA BROADCAST*\n\n${data.body}\n\n_#izin admin grup *${dataC.name}*_`)
        //     })
        // })
